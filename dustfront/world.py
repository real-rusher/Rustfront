...
# Zwei Etagen uebereinander. Gleiche Groesse, gleiche Aussenmauern, die
# Treppen liegen an denselben Stellen. Mehr Etagen: einfach eine dritte Liste.
...
def testkarte() -> Welt:
    return Welt([Ebene.aus_text(KARTE_E0, 0), Ebene.aus_text(KARTE_E1, 1)])
